...
get_nba_pbt <- function(start_year = 1996, stop_year = 2017) {
  nba_pbt <- list()
  
  for (yr_start in start_year:stop_year) {
  ...
  write_csv(nba_pbt, path = "~/basketball/analytics/data/nba_pbt.csv")  
}
...
get_nba_tbt <- function(start_year = 1996, stop_year = 2017) {
  nba_tbt <- list()
  ...
  write_csv(nba_tbt, path = "~/basketball/analytics/data/nba_tbt.csv")
...
get_nba_tadv <- function(start_year = 1996, stop_year = 2017) {
  nba_tadv <- list()
  ...
  write_csv(nba_tbt, path = "~/basketball/analytics/data/nba_tadv.csv")
...
get_nbadl_tbt <- function(start_year = 2007, stop_year = 2017) {
  nbadl_tbt <- tibble()
  ...
  write_csv(nbadl_tbt, path = "~/basketball/analytics/data/nbadl_tbt.csv")
  
}

# NBADL Player Basic Totals:

get_nbadl_pbt <- function(start_year = 2007, stop_year = 2017) {
  nbadl_pbt <- tibble()
  ...
  write_csv(nbadl_pbt, path = "~/basketball/analytics/data/nbadl_pbt.csv")
  
}

# NBADL Player Per100:
get_nbadl_pp100 <- function(start_year = 2007, stop_year = 2017) {
  nbadl_pp100 <- tibble()
  ...
  write_csv(nbadl_pp100, path = "~/basketball/analytics/data/nbadl_pp100.csv")
  
}


# NBADL Player Advanced:
get_nbadl_padv <- function(start_year = 2007, stop_year = 2017) {
  nbadl_padv <- tibble()
